...
check "${HOME}/.bashrc" "test -e \${HOME}/.bashrc"
check "${HOME}/.bash_profile" "test -e \${HOME}/.bash_profile"
check "${HOME}/.inputrc" "test -e \${HOME}/.inputrc"
check "${HOME}/.config/bash/aliases.sh" "test -e \${HOME}/.config/bash/aliases.sh"
check "${HOME}/.config/bash/functions.sh" "test -e \${HOME}/.config/bash/functions.sh"
check "${HOME}/.config/starship.toml" "test -e \${HOME}/.config/starship.toml"
check "${HOME}/.config/tmux/tmux.conf" "test -e \${HOME}/.config/tmux/tmux.conf"
check "${HOME}/.config/zellij/config.kdl" "test -e \${HOME}/.config/zellij/config.kdl"
check "${HOME}/.config/alacritty/alacritty.toml" "test -e \${HOME}/.config/alacritty/alacritty.toml"
